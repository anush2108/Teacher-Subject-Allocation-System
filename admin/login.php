        ...
        <div class="row">
            <div class="col-lg-6 col-lg-offset-3">
                <div class="login-content">
                    ...
                    <div style="background-color:white"; class="login-form">
                        ...
                        <form method="post">
                            ...
                            <div class="checkbox">
                                ...
                                <label class="pull-right">
                                    <a style="color:black"; href="forgot-password.php">Forgotten Password?</a>
                                </label>
                              

                            </div>
                            <button style="background-color:black"; type="submit" name="login" class="btn btn-primary btn-flat m-b-30 m-t-30">Sign in</button>
                            <label>
                                    <a style="color:black"; href="../index.php">Back Home!!</a>
                                </label>
                        </form>
                    </div>
                </div>
