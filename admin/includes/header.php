...
{               ?>
                <li class="header-icon dib"><img class="avatar-img" src="../assets/images/avatar/images (3).jpeg" alt="" /> <span class="user-avatar"> <?php  echo $row->AdminName;?> <i class="ti-angle-down f-s-10"></i></span>
