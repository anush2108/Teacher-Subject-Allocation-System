...
<?php include_once('includes/sidebar.php');?>
    ...
    <div style="background-color:black"; class="content-wrap">
        <div class="main">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        ...
                        <img src="images/sub.jpg" width="1255" height="200">
                        <p> </p>
                    </div>
                    <!-- /# column -->
                        ...
                        <div style="background-color:black"; class="page-header">
                            <div class="page-title">
                                <ol style="background-color:black"; class="breadcrumb text-right">
                                    ...
                                    <li style="color: white" class="active">Subject</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
{               ?>
            <option value="<?php  echo htmlentities($row->ID);?>"><?php  echo htmlentities($row->CourseName);?>(<?php  echo htmlentities($row->BranchName);?>)</option><?php $cnt=$cnt+1;}} ?>
                                ...
                                <button style="background-color:black"; class="btn btn-default btn-lg m-b-10 bg-warning border-none m-r-5 sbmt-btn" type="submit" name="submit">Save</button>
