                            ...
                            <form method="post" name="chngpwd" onSubmit="return valid();">
                                ...
                                <div class="checkbox">
                                    ...
                                    <label class="pull-right">
										<a style="color: black" href="login.php">signin</a>
									</label>

                                </div>
                                <button style="background-color:black"; type="submit" name="submit" class="btn btn-primary btn-flat m-b-30 m-t-30">Reset</button>
                            </form>
                        </div>
                    </div>
                </div>
