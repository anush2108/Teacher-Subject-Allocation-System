                        ...
                        <div class="page-header"style="background-color:black"; >
                            <div class="page-title">
                                <ol class="breadcrumb text-right" style="background-color:black";>
                                    ...
                                    <li style="color: white" class="active">Search</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div id="main-content">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <button style="background-color:black"; class="btn btn-default btn-lg m-b-10 bg-warning border-none m-r-5 sbmt-btn" type="submit" name="search">Submit</button>
