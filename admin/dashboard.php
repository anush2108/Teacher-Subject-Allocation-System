...
<style>
    .hello{
            ...
            background-image:url('hello.jpg.png');
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-4 p-l-0 title-margin-left">
                        <div  style="background-color:black";  class="page-header">
                            <div class="page-title">
                                <ol style="background-color:black"; class="breadcrumb text-right">
                                    <li style="color:white";>Dashboard</li>
                                    <li style="color:white"; class="active">Home</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /# column -->
                </div><!-- /# row -->
                <img src="d.jpg" alt="Image" width="1255" height="350">
                <div style="background-color:black"; id="main-content">
                    <div class="row">
                        <div class="col-md-6">
...
?>
                                        <h4 style="color: black">Total Courses</h4>
                                        <h4 style="color: black"><?php echo htmlentities($totcourse);?></h4>
...
?>
                                        <h4 style="color: black">Total Subjects</h4>
                                         <h4 style="color: black"><?php echo htmlentities($totsub);?></h4>
...
?>
                                       <h4 style="color: black">Total Teachers</h4>
                                         <h4 style="color: black"><?php echo htmlentities($totteacher);?></h4>
